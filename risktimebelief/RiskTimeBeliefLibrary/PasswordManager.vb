...
Public Class PasswordManager
    ...
    Public Shared Function VerifyPasswordFromInput(ByVal Stage As Integer, ByVal PasswordFileName As String) As Integer
        ...
        If (str.Trim() = passwords(Stage - 1)) Then Return VALIDATION_OK
        Return VALIDATION_WRONG_PASSWORD
    End Function

    Public Shared Function VerifyPasswordFromFile(ByVal Stage As Integer, ByVal PasswordFileName As String, ByVal AnswerFileName As String) As Integer
        ...
        Return VALIDATION_WRONG_PASSWORD
    End Function
    Public Shared Function VerifyPasswordFromBoth(ByVal Stage As Integer, ByVal PasswordFileName As String, ByVal AnswerFileName As String) As Integer
        If Not VerifyPasswordFromFile(Stage, PasswordFileName, AnswerFileName) = VALIDATION_OK Then
    ...
    Private Shared Function ReadPasswordFile(ByVal PasswordFileName As String) As String()
        ...
        Dim reader As TextReader = New StreamReader(PasswordFileName, System.Text.Encoding.Default)
        Dim str As String
    ...
    Private Shared Function ReadAnswerFile(ByVal AnswerFileName As String) As String
        ...
        Dim reader As TextReader = New StreamReader(AnswerFileName, System.Text.Encoding.Default)
        Dim str As String
        Dim check As Boolean = True
